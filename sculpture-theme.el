...
;;;;;; base
  ...
  (button                     (:foreground fg :background ot06
                               :box (:line-width -1 :color bw06)))
...
;;;;;; Header line and mode line
  ...
  (mode-line                  (:foreground fg   :background bw00 :box (:line-width 1 :color bw04)))
  (mode-line-buffer-id        (:foreground fg   :background bw00))
...
;;;;;;; custom
  (modeline-line                     (:inherit 'cursor :foreground bg))
