...
;;;;;; font-lock
   ...
   `(font-lock-comment-face              ((,class (:foreground bw10 :background haa09 :slant italic))))
   `(font-lock-comment-delimiter-face    ((,class (:foreground bw10 :background haa09 :slant italic))))
...
;;    `(mode-line-emphasis         ((,class (:foreground haa05 :background bw00))))
;;    `(mode-line-highlight        ((,class (:foreground haa05 :background bw00))))
;;    `(mode-line-inactive         ((,class (:foreground bw08 :background bw00 :box (:line-width 1 :color)) bw00)))

;; ;;;;;;; custom
;;    `(sculpture-theme-modeline-line                     ((,class (:inherit (cursor variable-pitch) :foreg))round bg))
;;    `(sculpture-theme-modeline-percent                  ((,class (:inherit (cursor variable-pitch) :foreg))round fg :background ot03))
;;    `(sculpture-theme-modeline-mode                     ((,class (:inherit variable-pitch :foreground ot0))5 :weight bold))
;;    `(sculpture-theme-modeline-workspace                ((,class (:inherit variable-pitch :foreground cs0))2))
...
;;    `(evil-ex-search                 ((,class (:foreground cs00 :background haa02 :weight bold))))
...
;; ;;;;;; Line Numbers
;;    `(line-number              ((,class (:foreground bw03 :background haa09))))
...
;;    `(+workspace-tab-selected-face ((,class (:foreground haa04 :background ot05))))
...
;;    `(sculpture-theme-head-outline-2 ((,class (:foreground ot05))))
;;    `(sculpture-theme-head-outline-3 ((,class (:foreground ot04))))
;;    `(sculpture-theme-head-outline-4 ((,class (:foreground cs02))))
;;    `(sculpture-theme-head-outline-5 ((,class (:foreground haa00))))
;;    `(sculpture-theme-head-outline-6 ((,class (:foreground ot10))))
;;    `(sculpture-theme-head-outline-7 ((,class (:foreground haa06))))
;;    `(sculpture-theme-head-outline-8 ((,class (:foreground ot07))))

;; ;;;;;; Outline
;;    `(outline-1 ((,class (:inherit (sculpture-theme-head-outline-1 variable-pitch) :overline t))))
;;    `(outline-2 ((,class (:inherit (sculpture-theme-head-outline-2 variable-pitch) :overline t))))
;;    `(outline-3 ((,class (:inherit (sculpture-theme-head-outline-3 variable-pitch) :overline t))))
;;    `(outline-4 ((,class (:inherit (sculpture-theme-head-outline-4 variable-pitch) :overline t))))
;;    `(outline-5 ((,class (:inherit (sculpture-theme-head-outline-5 variable-pitch) :overline t))))
;;    `(outline-6 ((,class (:inherit (sculpture-theme-head-outline-6 variable-pitch) :overline t))))
;;    `(outline-7 ((,class (:inherit (sculpture-theme-head-outline-7 variable-pitch) :overline t))))
;;    `(outline-8 ((,class (:inherit (sculpture-theme-head-outline-8 variable-pitch) :overline t))))
...
;;    `(org-special-keyword           ((,class (:foreground cs02 :background haa10))))
...
;;    `(company-tooltip            ((,class (:foreground fg :background haa09 :box (:color bw01)))))
