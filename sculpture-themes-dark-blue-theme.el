;;; sculpture-themes-dark-blue-theme.el --- Dark theme with vivid colors -*- lexical-binding: t; -*-
...
;; sculpture-themes-dark-blue : A dark theme for emacs with vivid colors, inspired by
;; coloring pigments.
...
;;;; Custom Faces
(defface sculpture-themes-dark-blue-head-outline-1        nil nil :group 'sculpture-themes-dark-blue)
(defface sculpture-themes-dark-blue-head-outline-2        nil nil :group 'sculpture-themes-dark-blue)
(defface sculpture-themes-dark-blue-head-outline-3        nil nil :group 'sculpture-themes-dark-blue)
(defface sculpture-themes-dark-blue-head-outline-4        nil nil :group 'sculpture-themes-dark-blue)
(defface sculpture-themes-dark-blue-head-outline-5        nil nil :group 'sculpture-themes-dark-blue)
(defface sculpture-themes-dark-blue-head-outline-6        nil nil :group 'sculpture-themes-dark-blue)
(defface sculpture-themes-dark-blue-head-outline-7        nil nil :group 'sculpture-themes-dark-blue)
(defface sculpture-themes-dark-blue-head-outline-8        nil nil :group 'sculpture-themes-dark-blue)
(defface sculpture-themes-dark-blue-modeline-percent      nil nil :group 'sculpture-themes-dark-blue)
(defface sculpture-themes-dark-blue-modeline-line         nil nil :group 'sculpture-themes-dark-blue)
(defface sculpture-themes-dark-blue-modeline-mode         nil nil :group 'sculpture-themes-dark-blue)
(defface sculpture-themes-dark-blue-modeline-workspace    nil nil :group 'sculpture-themes-dark-blue)
(defface sculpture-themes-dark-blue-variable-pitch-italic nil nil :group 'sculpture-themes-dark-blue)
(defface sculpture-themes-dark-blue-elfeed-title-1        nil nil :group 'sculpture-themes-dark-blue)
(defface sculpture-themes-dark-blue-elfeed-title-2        nil nil :group 'sculpture-themes-dark-blue)
(defface sculpture-themes-dark-blue-elfeed-title-3        nil nil :group 'sculpture-themes-dark-blue)
(defface sculpture-themes-dark-blue-elfeed-title-4        nil nil :group 'sculpture-themes-dark-blue)
(defface sculpture-themes-dark-blue-elfeed-title-5        nil nil :group 'sculpture-themes-dark-blue)
(defface sculpture-themes-dark-blue-elfeed-title-6        nil nil :group 'sculpture-themes-dark-blue)
(defface sculpture-themes-dark-blue-elfeed-title-7        nil nil :group 'sculpture-themes-dark-blue)
(defface sculpture-themes-dark-blue-elfeed-title-8        nil nil :group 'sculpture-themes-dark-blue)
(defface sculpture-themes-dark-blue-elfeed-star-face      nil nil :group 'sculpture-themes-dark-blue)

;;;; definition
(deftheme sculpture-themes-dark-blue
...
;;;;;; base
  (custom-theme-set-faces
   ...
   `(sculpture-themes-dark-blue-variable-pitch-italic      ((,class (:inherit variable-pitch :slant italic))))
...
;;;;;;; custom
   `(sculpture-themes-dark-blue-modeline-line                     ((,class (:inherit (cursor variable-pitch) :foreground ,bg))))
   `(sculpture-themes-dark-blue-modeline-percent                  ((,class (:inherit (cursor variable-pitch) :foreground ,fg :background ,ot03))))
   `(sculpture-themes-dark-blue-modeline-mode                     ((,class (:inherit variable-pitch :foreground ,ot05 :weight bold))))
   `(sculpture-themes-dark-blue-modeline-workspace                ((,class (:inherit variable-pitch :foreground ,cs02))))
...
;;;;;; Swiper
   `(swiper-background-match-face-1  ((,class (:inherit sculpture-themes-dark-blue-head-outline-2))))
   `(swiper-background-match-face-2  ((,class (:inherit sculpture-themes-dark-blue-head-outline-4))))
   `(swiper-background-match-face-3  ((,class (:inherit sculpture-themes-dark-blue-head-outline-5))))
   `(swiper-background-match-face-4  ((,class (:inherit sculpture-themes-dark-blue-head-outline-3))))
   `(swiper-line-face                ((,class (:underline ,ha04 :extend t))))
   `(swiper-match-face-1             ((,class (:inherit sculpture-themes-dark-blue-head-outline-2 :weight bold))))
   `(swiper-match-face-2             ((,class (:inherit sculpture-themes-dark-blue-head-outline-4 :weight bold))))
   `(swiper-match-face-3             ((,class (:inherit sculpture-themes-dark-blue-head-outline-5 :weight bold))))
   `(swiper-match-face-4             ((,class (:inherit sculpture-themes-dark-blue-head-outline-3 :weight bold))))
...
;;;;;; Sculpture-Themes-Dark-Blue-Head-Outline
   `(sculpture-themes-dark-blue-head-outline-1 ((,class (:foreground ,ha04))))
   `(sculpture-themes-dark-blue-head-outline-2 ((,class (:foreground ,ot05))))
   `(sculpture-themes-dark-blue-head-outline-3 ((,class (:foreground ,ot04))))
   `(sculpture-themes-dark-blue-head-outline-4 ((,class (:foreground ,cs02))))
   `(sculpture-themes-dark-blue-head-outline-5 ((,class (:foreground ,ha00))))
   `(sculpture-themes-dark-blue-head-outline-6 ((,class (:foreground ,ot10))))
   `(sculpture-themes-dark-blue-head-outline-7 ((,class (:foreground ,ha06))))
   `(sculpture-themes-dark-blue-head-outline-8 ((,class (:foreground ,ot07))))

;;;;;; Outline
   `(outline-1 ((,class (:inherit (sculpture-themes-dark-blue-head-outline-1 variable-pitch) :overline t))))
   `(outline-2 ((,class (:inherit (sculpture-themes-dark-blue-head-outline-2 variable-pitch) :overline t))))
   `(outline-3 ((,class (:inherit (sculpture-themes-dark-blue-head-outline-3 variable-pitch) :overline t))))
   `(outline-4 ((,class (:inherit (sculpture-themes-dark-blue-head-outline-4 variable-pitch) :overline t))))
   `(outline-5 ((,class (:inherit (sculpture-themes-dark-blue-head-outline-5 variable-pitch) :overline t))))
   `(outline-6 ((,class (:inherit (sculpture-themes-dark-blue-head-outline-6 variable-pitch) :overline t))))
   `(outline-7 ((,class (:inherit (sculpture-themes-dark-blue-head-outline-7 variable-pitch) :overline t))))
   `(outline-8 ((,class (:inherit (sculpture-themes-dark-blue-head-outline-8 variable-pitch) :overline t))))
...
;;;;;; markdown
   `(markdown-header-face-1 ((,class (:inherit sculpture-themes-dark-blue-head-outline-1))))
   `(markdown-header-face-2 ((,class (:inherit sculpture-themes-dark-blue-head-outline-2))))
   `(markdown-header-face-3 ((,class (:inherit sculpture-themes-dark-blue-head-outline-3))))
   `(markdown-header-face-4 ((,class (:inherit sculpture-themes-dark-blue-head-outline-4))))
   `(markdown-header-face-5 ((,class (:inherit sculpture-themes-dark-blue-head-outline-5))))
   `(markdown-header-face-6 ((,class (:inherit sculpture-themes-dark-blue-head-outline-6))))
...
;;;;;;; level
   `(org-level-1 ((,class (:inherit sculpture-themes-dark-blue-head-outline-1))))
   `(org-level-2 ((,class (:inherit sculpture-themes-dark-blue-head-outline-2))))
   `(org-level-3 ((,class (:inherit sculpture-themes-dark-blue-head-outline-3))))
   `(org-level-4 ((,class (:inherit sculpture-themes-dark-blue-head-outline-4))))
   `(org-level-5 ((,class (:inherit sculpture-themes-dark-blue-head-outline-5))))
   `(org-level-6 ((,class (:inherit sculpture-themes-dark-blue-head-outline-6))))
   `(org-level-7 ((,class (:inherit sculpture-themes-dark-blue-head-outline-7))))
   `(org-level-8 ((,class (:inherit sculpture-themes-dark-blue-head-outline-8))))
...
;;;;;; elfeed
   ...
   `(sculpture-themes-dark-blue-elfeed-title-1   ((,class (:inherit sculpture-themes-dark-blue-head-outline-1))))
   `(sculpture-themes-dark-blue-elfeed-title-2   ((,class (:inherit sculpture-themes-dark-blue-head-outline-2))))
   `(sculpture-themes-dark-blue-elfeed-title-3   ((,class (:inherit sculpture-themes-dark-blue-head-outline-3))))
   `(sculpture-themes-dark-blue-elfeed-title-4   ((,class (:inherit sculpture-themes-dark-blue-head-outline-4))))
   `(sculpture-themes-dark-blue-elfeed-title-5   ((,class (:inherit sculpture-themes-dark-blue-head-outline-5))))
   `(sculpture-themes-dark-blue-elfeed-title-6   ((,class (:inherit sculpture-themes-dark-blue-head-outline-6))))
   `(sculpture-themes-dark-blue-elfeed-title-7   ((,class (:inherit sculpture-themes-dark-blue-head-outline-7))))
   `(sculpture-themes-dark-blue-elfeed-title-8   ((,class (:inherit sculpture-themes-dark-blue-head-outline-8))))
   `(sculpture-themes-dark-blue-elfeed-star-face ((,class (:underline (:color ,ha04 :line-width -1)))))
...
;;;;;; orderless
   `(orderless-match-face-0 ((,class (:inherit sculpture-themes-dark-blue-head-outline-2 :weight bold))))
   `(orderless-match-face-1 ((,class (:inherit sculpture-themes-dark-blue-head-outline-4 :weight bold))))
   `(orderless-match-face-2 ((,class (:inherit sculpture-themes-dark-blue-head-outline-5 :weight bold))))
   `(orderless-match-face-3 ((,class (:inherit sculpture-themes-dark-blue-head-outline-3 :weight bold))))
...
(provide-theme 'sculpture-themes-dark-blue)

;;; sculpture-themes-dark-blue-theme.el ends here
