...
;; (defface sculpture-theme-head-outline-1 '((t :foreground "haa04")) nil :group 'sculpture-faces)
;; (defface sculpture-theme-head-outline-2 '((t :foreground "ott05")) nil :group 'sculpture-faces)
;; (defface sculpture-theme-head-outline-3 '((t :foreground "ott04")) nil :group 'sculpture-faces)
;; (defface sculpture-theme-head-outline-4 '((t :foreground "css02")) nil :group 'sculpture-faces)
;; (defface sculpture-theme-head-outline-5 '((t :foreground "haa00")) nil :group 'sculpture-faces)
;; (defface sculpture-theme-head-outline-6 '((t :foreground "ott10")) nil :group 'sculpture-faces)
;; (defface sculpture-theme-head-outline-7 '((t :foreground "haa06")) nil :group 'sculpture-faces)
;; (defface sculpture-theme-head-outline-8 '((t :foreground "ott07")) nil :group 'sculpture-faces)
